...
function esPrimo(numero) {
  ...
  if (numero !== Math.floor(numero) || numero === 0 || numero === 1) {return false};
  for(var i = 2; i < numero ; i++) {
  if (numero % i === 0) {return false};
  if (i === numero - 1) {return true};  
}
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  var x = [];
  for (var i = 0; i <= 60 ; i+=6) {var tabla = i ; x.push(tabla)};
  return x
}
